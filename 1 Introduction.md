...
- Collaborate with Designers and Backend Developers, Project Managers to ensure the final product meets the client's needs

---
#### (Main) Which languages are used for Frontend Development? 
- `HTML` - Markup Language used to create the structure of the page
- `CSS` - Cascading Style Sheet used to adjust how `HTML` elements are rendered
- `JavaScript` - Scripting language used to add interactivity and dynamism to websites

> [!NOTE] In Addition 
> TypeScript - A strongly typed superset of JavaScript that you can use instead

---
#### Required Skills for a Frontend Developer
